...
<a href="{{ '/assets/img/teaching/ss_faculty_attestation.pdf' | relative_url }}" target="_blank" class="btn btn-sm z-depth-0" role="button">View Faculty Attestation PDF</a>
...
- **Computer Programming** - Lab instructor for introductory computer programming course
- **Object-Oriented Programming in Java** - Lab instructor for OOP course covering Java fundamentals, classes, objects, inheritance, polymorphism, and advanced Java concepts
